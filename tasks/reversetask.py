...
def dataloader(num_batches,
               ...
               min_len,
               max_len):
    """Generator of random sequences for the reverse task.
    ...
    for batch_num in range(num_batches):
        ...
        tmp = seq.clone().numpy()[::-1].copy()
        outp = torch.from_numpy(tmp)
...
#
# To create a network simply instantiate the `:class:ReverseTaskModelTraining`,
# all the components will be wired with the default values.
# In case you'd like to change any of defaults, do the following:
#
# > params = ReverseTaskParams(batch_size=4)
# > model = ReverseTaskModelTraining(params=params)
#
...
# for evaluating.
#
# You may skip this alltogether, and use `:class:ReverseTaskNTM` directly.
#
